...
data.raw["transport-belt"]["transport-belt"].icon = "__SchematicDiagram+__/graphics/icons/transport-belt.png"
data.raw["transport-belt"]["transport-belt"].icon_size = 20
data.raw["item"]["transport-belt"].icon = "__SchematicDiagram+__/graphics/icons/transport-belt.png"
...
data.raw["transport-belt"]["transport-belt"].belt_animation_set = {
  animation_set =
  {
    filename = "__SchematicDiagram+__/graphics/entity/transport-belt.png",
    priority = "extra-high",
    width = 32,
    height = 32,
	scale = 2, 
...
data.raw["transport-belt"]["fast-transport-belt"].icon = "__SchematicDiagram+__/graphics/icons/fast-transport-belt.png"
data.raw["transport-belt"]["fast-transport-belt"].icon_size = 20

data.raw["item"]["fast-transport-belt"].icon = "__SchematicDiagram+__/graphics/icons/fast-transport-belt.png"
...
data.raw["transport-belt"]["fast-transport-belt"].belt_animation_set = {
  animation_set =
  {
    filename = "__SchematicDiagram+__/graphics/entity/fast-transport-belt.png",
    priority = "extra-high",
    width = 32,
    height = 32,
	scale = 2, 
...
data.raw["transport-belt"]["express-transport-belt"].icon = "__SchematicDiagram+__/graphics/icons/express-transport-belt.png"
data.raw["transport-belt"]["express-transport-belt"].icon_size = 20
data.raw["item"]["express-transport-belt"].icon = "__SchematicDiagram+__/graphics/icons/express-transport-belt.png"
...
data.raw["transport-belt"]["express-transport-belt"].belt_animation_set = {
  animation_set =
  {
    filename = "__SchematicDiagram+__/graphics/entity/express-transport-belt.png",
    priority = "extra-high",
    width = 32,
    height = 32,
	scale = 2, 
...
data.raw["splitter"]["splitter"].icon = "__SchematicDiagram+__/graphics/icons/splitter.png"
data.raw["splitter"]["splitter"].icon_size = 20
data.raw["item"]["splitter"].icon = "__SchematicDiagram+__/graphics/icons/splitter.png"
...
data.raw["splitter"]["splitter"].structure =
    {
      north =
      {
        filename = "__SchematicDiagram+__/graphics/entity/splitter-north.png",
        frame_count = 1,
        line_length = 1,
        priority = "extra-high",
        width = 41,
      ...
      east =
      {
        filename = "__SchematicDiagram+__/graphics/entity/splitter-east.png",
        frame_count = 1,
        line_length = 1,
        priority = "extra-high",
        width = 23,
      ...
      south =
      {
        filename = "__SchematicDiagram+__/graphics/entity/splitter-south.png",
        frame_count = 1,
        line_length = 1,
        priority = "extra-high",
        width = 41,
      ...
      west =
      {
        filename = "__SchematicDiagram+__/graphics/entity/splitter-west.png",
        frame_count = 1,
        line_length = 1,
        priority = "extra-high",
        width = 23,
...
data.raw["splitter"]["fast-splitter"].icon = "__SchematicDiagram+__/graphics/icons/fast-splitter.png"
data.raw["splitter"]["fast-splitter"].icon_size = 20
data.raw["item"]["fast-splitter"].icon = "__SchematicDiagram+__/graphics/icons/fast-splitter.png"
...
data.raw["splitter"]["express-splitter"].icon = "__SchematicDiagram+__/graphics/icons/express-splitter.png"
data.raw["splitter"]["express-splitter"].icon_size = 20
data.raw["item"]["express-splitter"].icon = "__SchematicDiagram+__/graphics/icons/express-splitter.png"
...
data.raw["underground-belt"]["underground-belt"].icon = "__SchematicDiagram+__/graphics/icons/underground-belt.png"
data.raw["underground-belt"]["underground-belt"].icon_size = 20
data.raw["item"]["underground-belt"].icon = "__SchematicDiagram+__/graphics/icons/underground-belt.png"
...
data.raw["underground-belt"]["underground-belt"].structure =
    {
      direction_in =
      {
        sheet =
        {
          filename = "__SchematicDiagram+__/graphics/entity/underground-belt-structure.png",
          priority = "extra-high",
          width = 96,
          height = 96,
          y = 96,
...
data.raw["underground-belt"]["fast-underground-belt"].icon = "__SchematicDiagram+__/graphics/icons/fast-underground-belt.png"
data.raw["underground-belt"]["fast-underground-belt"].icon_size = 20
data.raw["item"]["fast-underground-belt"].icon = "__SchematicDiagram+__/graphics/icons/fast-underground-belt.png"
...
data.raw["underground-belt"]["express-underground-belt"].icon = "__SchematicDiagram+__/graphics/icons/express-underground-belt.png"
data.raw["underground-belt"]["express-underground-belt"].icon_size = 20
data.raw["item"]["express-underground-belt"].icon = "__SchematicDiagram+__/graphics/icons/express-underground-belt.png"
